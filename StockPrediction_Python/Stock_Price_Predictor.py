...
x_train, y_train = build_data_subsets('AAPL', '20190701', '20190905')
x_test, y_test = build_data_subsets('AAPL', '20190905', '20190918')
...
print(measure_acc(session.run(y_output, feed_dict={x_input: x_train}), y_train))
print(measure_acc(session.run(y_output, feed_dict={x_input: x_test}), y_test))
